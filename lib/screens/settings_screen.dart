          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  children: [
                    Icon(
                      ...
                      size: 20,
                      color: isDark ? AppColors.info : AppColors.moderate,
                    ),
              ...
              Padding(
                ...
                child: Text(
                  'Light mode is recommended for outdoor use in bright conditions.',
                ...
                child: Column(
                  children: [
                    _DataRow(
                      ...
                      value: 'Open-Meteo (free, no key required)',
                    ),
                    _HDivider(),
                    _DataRow(
                      label: 'Alert source',
                      value: 'Meteo Rwanda / ICPAC (demo)',
                    ),
                    _HDivider(),
                    _DataRow(
                      label: 'Last sync',
              ...
              _HelpCard(
                ...
                title: 'Home screen',
                body:
                    'Shows your current weather, temperature and rain probability. The active alert banner appears here when something is happening in your area. Tap it to see details.',
              ),
              ...
              _HelpCard(
                ...
                title: 'Alerts screen',
                body:
                    'See all current alerts for your location. Tap any alert to read the full explanation and safety steps. Tap the refresh icon at the top right to pull the latest data.',
              ),
              const SizedBox(height: 8),
              _HelpCard(
                ...
                body:
                    'Switch between 24-Hour and 10-Day tabs. The 24-Hour tab shows hourly temperature, rain chance and wind. The 10-Day tab shows daily highs, lows and rainfall totals. Pull down to refresh.',
              ),
              const SizedBox(height: 8),
              _HelpCard(
