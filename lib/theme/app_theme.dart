...
class AppColors {
  ...
  static Color cardAlt(BuildContext ctx) =>
      _isDark(ctx) ? darkCardAlt : lightCardAlt;
  static Color border(BuildContext ctx) =>
      _isDark(ctx) ? darkBorder : lightBorder;
  static Color borderLight(BuildContext ctx) =>
      _isDark(ctx) ? darkBorderLight : lightBorderLight;
  static Color textPrimary(BuildContext ctx) =>
      _isDark(ctx) ? darkTextPrimary : lightTextPrimary;
  static Color textSecondary(BuildContext ctx) =>
      _isDark(ctx) ? darkTextSecondary : lightTextSecondary;
  static Color textMuted(BuildContext ctx) =>
      _isDark(ctx) ? darkTextMuted : lightTextMuted;
  static Color textDisabled(BuildContext ctx) =>
      _isDark(ctx) ? darkTextDisabled : lightTextDisabled;
...
class AppSeverity {
  ...
  static const critical = SeverityStyle(
    ...
    dimColor: AppColors.criticalDim,
    glowColor: AppColors.criticalGlow,
    label: 'CRITICAL',
  );
  static const high = SeverityStyle(
    color: AppColors.high,
    dimColor: AppColors.highDim,
    glowColor: AppColors.highGlow,
    label: 'HIGH',
  );
  static const moderate = SeverityStyle(
    color: AppColors.moderate,
    dimColor: AppColors.moderateDim,
    glowColor: AppColors.moderateGlow,
    label: 'MODERATE',
  );
...
class AppText {
  ...
  static Color _primary(BuildContext? ctx) =>
      ctx != null ? AppColors.textPrimary(ctx) : AppColors.darkTextPrimary;
  static Color _secondary(BuildContext? ctx) =>
      ctx != null ? AppColors.textSecondary(ctx) : AppColors.darkTextSecondary;
  static Color _muted(BuildContext? ctx) =>
      ctx != null ? AppColors.textMuted(ctx) : AppColors.darkTextMuted;
